...
### Article.Religion. Bluebeard, the resourceful Odysseus, and the original sin (en). Άρθρο. Θρησκεία. Ο Κυανοπώγων, ο πολυμήχανος Οδυσσέας και το προπατορικό αμάρτημα (el). Αrthro. Threskeιa. O Kyanopοgon, o polymechanos Odyssεas kai to propatorekο amαrtema.
...
- στον επίλογο, το συμπέρασμα που προκύπτει από την επιστροφή στις τρείς προαναφερθείσες αφηγήσεις.
  ...
  Εικόνα 3: Η αποπομπή από τον παράδεισο. [3]
...
> φῶς εἰς ἀποκάλυψιν ἐθνῶν καὶ δόξαν λαοῦ σου ᾿Ισραήλ. **Κατά Λουκάν, 29-31**
 ...
 μεταβαίνοντας έτσι απλά, αλλά θριαμβευτικά, από την ορθολογική αθανασία προς την χριστιανική αιωνιότητα.
...
Ποιο είναι το αποτέλεσμα της ελεύθερης βούλησης του παρασυρμένου ανθρώπου της Βιβλικής αφήγησης, στην άποψη, ότι όλα μας επιτρέπονται, χωρίς όρια;
